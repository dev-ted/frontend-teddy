...
export default function ProjectsCard({
  ...
  return (
    <>
      <div
        key={key}
        className="bg-neutral shadow-md snap-start snap-always    md:px-5 dark:border-gray-900 rounded-lg max-w-sm md:w-[500px] w-full m-auto h-full flex flex-col  "
      >
        <Image
        ...
        <div className=" py-4 ">
          ...
          <p className="font-normal flex-1  mb-3">{description}</p>
          ...
          <div className=" flex flex-col items-end   md:flex-row justify-between gap-4">
            {preview && (
              <Link
                target="_blank"
                href={preview}
                className="  font-medium rounded-lg text-sm  py-2  inline-flex items-center   "
              >
                Preview
                <svg
